...
interface ProductRepository {
    suspend fun postAddProduct(addProductRequest: AddProductRequest): Flow<ProductDataResource>
...
class ProductRepositoryImpl @Inject constructor(
    ...
    override suspend fun postAddProduct(addProductRequest: AddProductRequest): Flow<ProductDataResource> =
        flow {
            emit(proceed { productDatasource.postAddProduct(addProductRequest) })
        }
